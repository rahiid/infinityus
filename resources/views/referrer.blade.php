...
<head>
    ...
    <title>INFINITYUS | Referrer</title>
                            ...
                            <div class="sidebar-bottom">
                                ...
                                <div id="minvestment" class="collapse" data-parent="#minvestment">
                                    <ul>
                                        ...
                                        <a class="dropdown-item" href="/invesmenthistory">View Investment</a>
                                    </ul>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="referrer-section-inner">

                        @if(Auth::check())
                        @if (count($userdata))
                            @foreach ($userdata as $userdata)

                                        <p  id="referrerlink">http://infinityus.net/register?uid={{$userdata['id']}}&ulevel={{$hashll}}</p> <br> <br>
                                        <sup>Copy and paste this link to your friends and family</sup>
                                       <br> <a class="btn" onclick="copyToClipboard()">Copy Link</a>
                    ...
                    <h1 style="color: #0A2463;">No Link Available!!</h1>
