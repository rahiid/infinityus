...
<head>
    ...
    <title>INFINITYUS | Transfer History</title>
...
<body>
    ...
    <section class="exchange-section">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="transfer-history-header">
                        <h2>Transfer Statement Sent</h2>
                    </div>


                    <div class="transfer-history" id="scrollbar">
                        <table class="table table-responsive-md table-bordered">


                            @if(Auth::check())
                            @if (count($totalbalancetransfer))
                            <thead>
                                <tr>
                              ...
                              <tbody>
                                ...
                                @foreach ($totalbalancetransfer as $totalbalancetransfer)
                                    <tr>


                                        <td>{{ Str::limit($totalbalancetransfer['created_at'], 10) }}</td>

                                        <td>{{$totalbalancetransfer['receiverusername']}}</td>
                                        <td>{{$totalbalancetransfer['ammount']}}</td>
                                        <td>{{$totalbalancetransfer['status']}}</td>
                              ...
                              @else
                              <h4 style="color: #0A2463;">No Data to Show!!!</h4>
                              @endif
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="transfer-history-header">
                    <h2>Transfer Statement Received</h2>
                </div>
                    ...
                    <table class="table table-responsive-md table-bordered">
                        ...
                        <thead>
                          ...
                          <tbody>
                            ...
                            @foreach ($morebalancetransfer as $morebalancetransfer)
                                <tr>


                                    <td>{{ Str::limit($morebalancetransfer['created_at'], 10) }}</td>

                                    <td>{{$morebalancetransfer['senderusername']}}</td>
                                    <td>{{$morebalancetransfer['ammount']}}</td>
                                    <td>{{$morebalancetransfer['status']}}</td>
