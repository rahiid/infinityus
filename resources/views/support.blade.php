...
<head>
    ...
    <title>INFINITYUS | Support</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="contractus-inner d-flex justify-content-center">
                        ...
                        <div class="col-md-8">
                            <form method="POST" id="contact-form" name="contact-form" action="contractus" style="justify-content: center; width:100%">
                                @csrf
                                <!--Grid row-->
                                <div class="">
                                ...
                                <div class="send-btn" style="margin-top: 30px; width:100%;  text-align:center;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="address" style="width: 100%; text-align:center; margin-top:40px;">
                    <p>Infinityus Infotech LTD <br>
                        2625 Townsgate Rd, Westlake Village, CA, 91361<br>
                        (202) 298-6270<br>
                    </p>
                </div>
            </div>
