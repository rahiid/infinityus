...
<head>
    ...
    <title>INFINITYUS | Investment History</title>
    ...
    <link rel="stylesheet" href="{{asset('/css/investhistory.css')}}">
    <!-- Styles -->
...
<body>
  ...
  <!--========================== User invest Section ============================-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-3 mx-auto">
                            <div class="pricing-box" id="beginar">
    ...
    @elseif ((Auth::user()->package)== 'sweep')
    <section id="pricing" class="wow fadeInUp section-bg">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-3 mx-auto">
                        <div class="pricing-box" id="sweep">
                            <h3>Sweep Trader</h3>
                            <div class="cur">
                              <span>$</span>
                              <h2>50</h2>
    ...
    @elseif ((Auth::user()->package)== 'ethnic')
    <section id="pricing" class="wow fadeInUp section-bg">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 mx-auto">
                    <div class="pricing-box" id="ethnic">
                        <h3>Ethnic Trader</h3>
                        <div class="cur">
                          <span>$</span>
                          <h2>100</h2>
    ...
    <section id="pricing" class="wow fadeInUp section-bg">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 mx-auto">
                    <div class="col-md-12">
                        <div class="pricing-box" id="silver">
                            <h3>Silver Trader</h3>
                            <div class="cur">
                              <span>$</span>
                              <h2>200</h2>
    ...
    @elseif ((Auth::user()->package)== 'golden')
    <section id="pricing" class="wow fadeInUp section-bg">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-3 mx-auto">
                        <div class="pricing-box" id="golden">
                            <h3>Golden Trader</h3>
                            <div class="cur">
                              <span>$</span>
                              <h2>350</h2>
    ...
    <section id="pricing" class="wow fadeInUp section-bg">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-3 mx-auto">
                        <div class="pricing-box" id="diamond">
    ...
    <section id="pricing" class="wow fadeInUp section-bg">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-3 mx-auto">
                        <div class="pricing-box" id="platinum">
    ...
    @elseif ((Auth::user()->package)== 'none')
    <div class="container not-invested" style="text-align: center; padding-top: 40px;">
        <div class="row">
            <div class="col-md-12" id="gotoinvest">
                <h2 style="color: #0A2463;">You Have Not Invested Yet!</h2>
                <h4 style="padding-bottom: 30px;" style="color: #0A2463;">Please Invest to Continue</h4>
                <a  href="/investment"  class="btn btn-primary" >Invest</a>
            </div>
        </div>
    </div>
    @endif
    @else
    <h2 style="color: #0A2463;">NO Data to Show!!</h2>
    @endif
