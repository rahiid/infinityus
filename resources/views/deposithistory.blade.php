...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/css/deposithistory.css')}}">
    <!-- Styles -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="diposit-section-inner" id="scrollbar">
