...
<head>
    ...
    <title>INFINITYUS | DASHBOARD</title>
                ...
                <div class="col-md-12">
                    <nav class="nav navbar">
                        <span class="nav-link" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
                            <img src="/image/menu.svg" style="width:40px; height:35px;" class="img-responsive menu"  alt="menu">
                                </i></span>
    ...
    <section class="user-section">
        <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="user-section-inner">
                        ...
                        <div class="card" style="width: 18rem;">
                            <div class="img-wrp">
                                <img src="image/dashboard/wallet.svg" class="card-img-top" alt="...">
                            </div>
                            <div class="card-body">
                                <h5>
                                    My Wallet
                                </h5>
                            <p class="card-text">{{{ isset(Auth::user()->name) ? Auth::user()->wallet : Auth::user()->email }}} <strong>USD</strong></p>
                            </div>
                        </div>

                        <div class="card" style="width: 18rem;">
                            <div class="img-wrp">
                                <img src="image/dashboard/profit.svg" class="card-img-top" alt="...">
                            </div>
                            <div class="card-body">
                                <h5>
                                    Total Profit
                                </h5>
                                <p class="card-text">00.00 <strong>USD</strong></p>
                            </div>
                        </div>

                        <div class="card" style="width: 18rem;">
                            <div class="img-wrp">
                                <img src="image/dashboard/reffer.svg" class="card-img-top" alt="...">
                            </div>
                            <div class="card-body">
                                <h5>
                                    Referred Users
                                </h5>
                                <p class="card-text"> {{$refferuser}} <strong>USER</strong></p>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                   <div class="user-section-inner">
                    ...
                    <div class="card" style="width: 18rem;">
                        <div class="img-wrp">
                            <img src="image/dashboard/withdraw.svg" class="card-img-top" alt="...">
                        </div>
                        <div class="card-body">
                            <h5>
                                Total Withdraw
                            </h5>
                            <p class="card-text">{{$total_withdraw}} <strong>USD</strong></p>
                        </div>
                    </div>

                    <div class="card" style="width: 18rem;">
                        <div class="img-wrp">
                            <img src="image/dashboard/balance.svg" class="card-img-top" alt="...">
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">{{{ isset(Auth::user()->name) ? Auth::user()->inf : Auth::user()->email }}} <strong>INF</strong></p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget">
                        <h6 style="text-align: center; color:red;">Personal Trading Chart</h6>
                        <div class="widget-inner">
                            <!-- TradingView Widget BEGIN -->

                                <div class="tradingview-widget-container">
                                    <div id="tradingview_98b76"></div>
                                    ...
                                    "container_id": "tradingview_98b76"
                                }
                                    );
                                    </script>
                                </div>
