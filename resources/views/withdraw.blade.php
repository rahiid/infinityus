...
<head>
    ...
    <title>INFINITYUS | Withdraw</title>
...
<body>
    ...
    <section class="withdraw-section">
        <div class="container">
                ...
                <div class="col-md-4">
                    <div class="withdraw-info">
                        ...
                        <div class="card">
                            ...
                            <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"><i class="fas fa-plus fa-xs"></i> &nbsp; Request Withdraw</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="collapse withdraw-section-inner" id="collapseExample" style="text-align: center">
                        ...
                        <div class="withdraw-items">
                            <div class="withdraw-selection input-group mb-3">
                                ...
                                <select class="custom-select" id="setwallettype">
                                  ...
                                  <option value="BTC"  id="btc"  name="payment_type">BTC </option>
                                  <option value="LTC"  id="ltc"  name="payment_type">LTC </option>
                                  <option value="XLM"  id="xlm"  name="payment_type">XLM </option>
                                  <option value="USDT" id="usdt" name="payment_type">USDT</option>
                                </select>
                              </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="withdraw-control withdraw-input" type="text" id="walletid" name="walletid" style="width: 60%;" required>

                            </div>

                            <div class="form-group" >
                                <label class="my-1 mr-2  withdraw-input" for="inlineFormCustomSelectPref" >Ammount</label> <br>
