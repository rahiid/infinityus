...
<head>
    ...
    <title>INFINITYUS | Withdraw History</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="text-align: center;">
                    ...
                    <div class="withdraw-history-table" id="scrollbar">
                        <table class="table table-responsive-md table-bordered" style="width:100%;">
