...
<head>
    ...
    <title>INFINITYUS | Balance Transfer</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="exchange-section-inner">
                        <div class="balance-wrapper">
                            <h2>Wallet BALANCE</h2> <br>
                            <h3>
                                @if(Auth::check())
                                   {{{ isset(Auth::user()->name) ? Auth::user()->wallet : Auth::user()->email }}} <strong>USD
                                    @else
                                    Balance
                                    @endif
                            </strong></h3>
                        ...
                        <div class="main-exhange">
                            <h4>Balance Transfer -<span >INFINITYUS</span></h4>
                            ...
                            <form method="POST" class="balancetransfer-inner" name="balancetransfer" action="balancetransfer"  onsubmit="transfermoney12.disabled = true; return true;">
                                ...
                                <input type="hidden" name="senderusername" value="{{ Auth::user()->username }}">
                                @else
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ammount" step="0.00001" min="2" max="{{ Auth::user()->wallet }}" class="form-control" required>

                                  </div>


                                <button type="submit" name="transfermoney12" class="btn btn-primary">Transfer</button>
                              </form>
                        </div>
