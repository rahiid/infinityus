...
<head>
    ...
    <title>INFINITYUS | Exchange</title>
                ...
                <div class="col-md-12">
                    ...
                    <div class="exchange-section-inner">
                        <div class="balance-wrapper">
                            <h2>Coin BALANCE</h2> <br>
                            <h3>
                                @if(Auth::check())
                                   {{{ isset(Auth::user()->name) ? Auth::user()->inf : Auth::user()->email }}} <strong>INF
                                    @else
                                    Balance
                                    @endif
                            </strong></h3>
                        ...
                        <div class="main-exhange">
                            <a type="button" href="/cominginjanuary" class="btn btn-primary">Exchange Coin</a>
                        </div>
